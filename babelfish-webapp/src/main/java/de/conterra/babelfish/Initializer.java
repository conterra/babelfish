...
public class Initializer
{
	...
	/**
	 * the root {@link URL} to the folder to store files (like configurations,
	 * plugins, etc.)
	 * 
	 * @since 0.2.1
	 */
	...
	/**
	 * the {@link ReschedulableTimer}, which calls the
	 * {@link Initializer#shutdown()}, if no requests are registered for a while
	 * 
	 * @since 0.1
	 */
	public static final ReschedulableTimer SHUTDOWN_TIMER = new ReschedulableTimer(new Runnable()
	{
		@Override
		public void run()
		{
	 ...
	 * 
	 * @since 0.1
	 * @see <a href="http://resources.arcgis.com/en/help/rest/apiref/">ArcGIS
	 *      REST API</a>
	 */
	 ...
	 * @param loadPlugins <code>true</code>, if the plugins folder should be
	 *        scanned and all plugins loaded
	 * @return <code>true</code>, if the initialization finished successfully
	 */
	 ...
	 * @since 0.1
	 * 
	 * @return <code>true</code>, if all {@link Plugin}s were successfully
	 *         unloaded
	 */

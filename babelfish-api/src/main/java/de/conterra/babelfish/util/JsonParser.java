...
public class JsonParser
{
	...
	/**
	 * helper method, to get a {@link CoordinateReferenceSystem} from a
	 * {@link JSONObject} or a call
	 * 
	 * @since 0.1
	 * 
	 * @param json the {@link JSONObject} to parse
	 * @param crs the {@link CoordinateReferenceSystem} to use, if the
	 *        {@link JSONObject} have no
	 * @return the {@link CoordinateReferenceSystem} to use
	 * @throws IllegalArgumentException if the {@link JSONObject} has no and the
	 *         call gives no valid {@link CoordinateReferenceSystem}
	 */
	 ...
	 * @throws JSONException if the {@link JSONObject} is not a valid
	 ...
	 *        Only needed, if the {@link JSONObject} contains no
	 *        {@link CoordinateReferenceSystem}
